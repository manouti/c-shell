...
main	(int argc, char *argv[])
{
    ...
    {
		fName	=(pANTLR3_UINT8)"../Test Examples/Input 1"; // Note in VS2005 debug, working directory must be configured
    }
    else
    {
    ...
    //
    lxr	    = GuoliceLexerNew(input);	    // CLexerNew is generated by ANTLR
    ...
    //
    psr	    = GuoliceParserNew(tstream);  // CParserNew is generated by ANTLR3
